...
<p style="margin: 0; font-size: 30px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 36px; margin-top: 0; margin-bottom: 0;"><span style="font-size: 30px;"><strong>${emailsMultiplosUsuarios!==undefined  ? "Você possui um novo agendamento familiar!" : "Você possui um novo agendamento!"}</strong></span></p>
</div>
</div>
...
<p style="margin: 0; font-size: 14px; line-height: 2; word-break: break-word; mso-line-height-alt: 28px; margin-top: 0; margin-bottom: 0;">✉️ ${emailsMultiplosUsuarios!==undefined ? emailsMultiplosUsuarios : 'Sem convidados'} </p> 
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
